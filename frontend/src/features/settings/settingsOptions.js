...
export const EQUIPMENT_SETUP_OPTIONS = [
  ...
  },
  {
    ...
    description: "A well-equipped gym with common machines, cables, racks, and free weights.",
    icon: "domain",
  },
  {
    value: "home_gym",
...
export const EQUIPMENT_PRESETS = {
  ...
  commercial_gym: [
    ...
    "selectorized_ab_crunch",
    "selectorized_chest_press",
    "selectorized_hip_abduction",
    "selectorized_hip_adduction",
    "selectorized_incline_press",
    "selectorized_leg_extension",
    "selectorized_lying_leg_curl",
    "selectorized_lat_pulldown",
    "pullover_machine",
    "selectorized_pec_deck",
    "selectorized_preacher_curl",
    "selectorized_reverse_pec_deck",
    "selectorized_seated_leg_curl",
    "selectorized_seated_row",
    "shoulder_press_machine",
    "selectorized_triceps_extension",
    "smith_machine",
    "squat_rack",
    "stability_ball",
    "stair_climber",
  ...
  full_gym: [
    ...
    "selectorized_ab_crunch",
    "selectorized_chest_press",
    "selectorized_glute_kickback",
    "selectorized_hip_abduction",
    "selectorized_hip_adduction",
    "selectorized_incline_press",
    "selectorized_lateral_raise",
    "selectorized_leg_extension",
    "selectorized_lying_leg_curl",
    "selectorized_lat_pulldown",
    "pullover_machine",
    ...
    "selectorized_seated_row",
    "shoulder_press_machine",
    "selectorized_standing_leg_curl",
    "selectorized_triceps_extension",
    "smith_machine",
    "squat_rack",
    "stability_ball",
...
export const PAIN_SEVERITY_V2_OPTIONS = [
  { value: "low", label: "Low" },
  { value: "moderate", label: "Moderate" },
  { value: "high", label: "High" },
  { value: "severe", label: "Severe" },
...
export const TRAINING_RULE_V2_OPTIONS = [
  {
    value: "monitor",
    label: "Monitor symptoms",
    description: "Keep the movement available, but pay attention to symptoms and tolerance.",
...
export const EQUIPMENT_CATEGORIES = [
  ...
  },
  {
    ...
    items: [
      ...
      { value: "pullover_machine", label: "Pullover Machine" },
